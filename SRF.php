...
<section class="section container-fluid" id="blog">
  <div class="section-title text-center text-uppercase">
    <h2 class="underlined">Tenant Registration Form</h2>
  </div>
  <div class="container">
    <div class="row">
...
<form action="contact.php" method="post" name="form1" id="contact-form">
          ...
          <input name="txtnname" required type="text" id="Name" form="contact-form" placeholder="Name">
          ...
          <input name="photo"  required type="File" id="photo" form="contact-form" placeholder="photo">
           <input name="Register" type="submit" class="btn btn-primary" id="submit" formaction="SRF.php" value="Register">
         <input name="Reset" type="submit" class="btn btn-primary" id="submit" formaction="SRF.php" value="Reset">
</form>
...
$sql=mysqli_query($conn,"insert into registration values('$apt','$name','$type','$phone','$date','$photo')");
if($apt==null||$name=null||$type==null||$phone||$date||$photo==null)
{
echo" "; 
}
else if($sql!=0)
{
echo"the record is successfully inserted";
}

else
echo"the record is not successfully inserted";
